module.exports = app =>{
    ...
    router.get('/news/init', async (req,res)=>{
        ...
        const newsTitles = ["被CCTV记录的王者荣耀，国人自己的电竞舞台", "新皮肤爆料丨西子湖畔再续前缘，小乔换装化身青蛇~", "体验服爆料丨拒绝被抢野，loading能打气，峡谷调整抢先知", "全新限时活动玩法【万镜觉醒】3.13开启，五倍快乐等你来~", "王者音乐课：五岳山河志", "3月18日全服不停机更新公告", "3月17日全服不停机更新公告", "3月17日体验服不停机更新公告", "3月17日体验服停机更新公告", "3月16日净化游戏环境声明及处罚公告", "【手Q用户专属】买小乔-青蛇 新皮肤，抽取免单奖励", "春暖花开聚峡谷 多重好礼领不停", "白色情人节【玫瑰芬芳，纸短情长】活动公告", "白色情人节 浪漫好礼来袭", "峡谷女神节 福利大集结", "关于王者荣耀国际轮回赛（KPLGT）积分年的计算规则", "王者荣耀国际巡回赛（KPLGT）2020年春季赛开赛时间公告", "2020年KPL春季赛大名单公布", "2020年KPL春季赛“云开赛”在即 全新视觉与六大城市主场来袭！", "高校联赛女神挑战赛周末开赛啦！来看高颜值组合强强联手"]
        ...
        const cats = await Category.aggregate([
            {$match: {parent:parent._id}},      //数据过滤分类
            {
                $lookup: {     //类似于join以cat为主体查另外一个集合，根据分类_id关联的文章表的外键去查询文章
                    from:'articles',     //关联那一个表
                    localField:'_id',   //本地键
                    foreignField:'categories',     //相当于外键，article表中用的关联字段
                    as:'newsList'   //名字
                },
            },
            {
